...
export const Loading: React.FC = () => <div>Loading authentication details...</div>;
...
export const ProtectedRouteOutlet: React.FC<ProtectedRouteProps> = ({ children }) => {
...
// This is the main component that will be used in route definitions:
// <Route element={<ProtectedRoute />} >
//   <Route path="dashboard" element={<DashboardPage />} />
// </Route>
// The HOC handles the protection.
const ProtectedRoute = withAuthenticationRequired(ProtectedRouteOutlet, {
